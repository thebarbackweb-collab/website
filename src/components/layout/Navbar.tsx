          ...
          <nav className={styles.desktopMenu}>
            {!user ? (
              <>
                ...
                <Link to="/rentals" className={styles.navLink}>Ingredients & Rent Equipments</Link>
          ...
          >
            {!user ? (
              <>
                ...
                <Link to="/rentals" className={styles.navLink} onClick={() => setMobileMenuOpen(false)}>Ingredients & Rent Equipments</Link>
